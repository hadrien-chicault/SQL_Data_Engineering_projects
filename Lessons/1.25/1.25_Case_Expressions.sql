...
ORDER BY RANDOM()
LIMIT 20;
-- Conditionnal Aggreagation
-- Calculate Median Salaies for different Buckets
-- < $100K
-- >= $100K
SELECT job_title_short,
...
-- Fianl ewample: Conditionnal Calcu ing yearly and adjusted hourly salary (e.g 2080 jhours/year)
-- Categorize salaruies into tiers of:
-- <75K 'Low'
-- 75K - 150K 'Medium'
-- >= 150K 'High'
WITH salaries AS (
